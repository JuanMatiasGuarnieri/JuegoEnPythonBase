...
<<<<<<< HEAD
    ...
    def shoot1(self):
        ...
        #bullet = Bullet(self.rect.centerx + 15, self.rect.top)
...
<<<<<<< HEAD
    ...
    # detectar-colision-nave-huevo
    hits = pygame.sprite.spritecollide(player, huevo_list,True)  # con True desapareden los objetos,con False no pasa nada
    for hit in hits:
